<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2 class="tituloPaginaActual">Editar Cuota</h2>
        <ol class="breadcrumb">
            <li><a href="<?= base_url() ?>">Inicio</a></li>
            <li class="active"><strong>Editar Cuota</strong></li>
        </ol>
    </div>
                ...
                <div class="ibox-content">
                    <form id="editar" class="form-horizontal" method="post" accept-charset="utf-8" >
                        <div class="form-group">
                            <label class="col-sm-3 control-label campoObligatorio">Monto de Cuota a Editar</label>
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <input type="text" class="form-control" name="cuota_1" value="<?= $cuota->Monto ?>" readonly required>
                                </div>  
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label campoObligatorio">Expiracion de Cuota a Editar</label>
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <input type="text" class="form-control" name="fe_1" value="<?= $cuota->Fecha_Expiracion ?>" readonly required>
                                </div>  
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label campoObligatorio">Monto de Nueva Cuota</label>
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    <input type="text" class="form-control" name="cuota" placeholder="000.00" required>
                                </div>  
                        </div>
                        <div class="form-group">
                    ...
                    si: function(){
                        $.confirm({
                            ...
                            content: function(){
                                var self = this
                                return $.ajax({
                                    url: '<?= base_url('alumnos/editarcuota/').$cuota->id."/".$cuota->Pagos_id."/".$id_alumno ?>',
                                    method: 'post',
                                    dataType: 'JSON',
                                    data: data
